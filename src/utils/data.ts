const services = [
    ...
    {
        title: "Restaurações",
        description: "As restaurações odontológicas são procedimentos que visam recuperar dentes danificados por cáries ou traumas, restaurando sua forma, função e estética.",
       
    },
    {
        title: "Ortodontia",
        description: "A ortodontia é a especialidade que corrige problemas de alinhamento dental e irregularidades na arcada dentária, utilizando aparelhos ortodônticos para garantir um sorriso saudável e harmônico.",
        
    },
    {
        title: "Tratamento de Canal",
        description: "O tratamento de canal é um procedimento que remove a infecção da polpa dental, aliviando a dor e salvando o dente. Ele é essencial para preservar a saúde bucal e evitar extrações.",
